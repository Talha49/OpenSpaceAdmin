...
const Loader = ({ size = 50 }) => {
  return (
    ...
    >
      <div
        className={`w-32 h-32 rounded-2xl border dark:border-neutral-700 shadow-md dark:shadow-neutral-950 bg-white dark:bg-neutral-800 flex items-center justify-center`}
      >
