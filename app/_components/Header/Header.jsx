...
const Header = () => {
  ...
  return (
    <div className="flex  w-full  justify-between leading-[60px] border-b  px-8 bg-white dark:bg-gray-800 text-black dark:text-white sticky  top-0 z-10 cursor-pointer">
        ...
        {showDialog && (
          <div className="absolute top-12 right-0 w-[340px]  z-[-10] bg-white shadow-lg border py-2 border-gray-200 rounded-md px-4">
            ...
            <div className="flex justify-between text-gray-500 py-3 px-1 text-sm">
              <Link
                href="/Profile"
                className="hover:underline leading-tight uppercase "
              >
                View Profile
              </Link>
              <Link
